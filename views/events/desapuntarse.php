<div class="d-flex gap-2">
    <?php if ($_SESSION['is_logged_in']) : ?>
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="get">
            <h4>¿Quiere desapuntarse del evento: <?php echo $_GET['titulo'] ?> en <?php echo $_GET['nombreProv']; ?>?</h4>
            ...
            <input type="submit" class="btn btn-success w-50 fa" value="&#xf068; Desapuntarse del evento">
