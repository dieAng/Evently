<div class="container mt-4">
    <div class="row columna-fija">
        <main class="col-md-9">
            <h4 class="mb-4"><i class="fa-solid fa-thumbtack"></i> Mis Eventos - En los que estoy apuntado</h4>
            <?php if ($viewmodel) : ?>
            ...
            <?php else : ?>
                ...
                <h5>Todavía no has creado ningún evento, <a href="<?php echo ROOT_URL; ?>/home/index">vamos a
                        cambiarlo!</a></h5>
